...
namespace Presentation
{
    public class CreateTicket
    {
        ...
        private readonly int maxCar = 48;
        private int cortar;
        ...
        public string LineasAsteriscos()
        {
            ...
            for (int i = 0; i < maxCar; i++)
            {
                lineasAsterisco += "_";//Agregara un asterisco hasta llegar la numero maximo de caracteres.
            }
        ...
        public void EncabezadoVenta2()
        {
            //Escribimos los espacios para mostrar el articulo. En total tienen que ser 40 caracteres
            linea.AppendLine("ARTÍCULO                              |CANT|PRECIO|IMPORTE");
        }
        public void EncabezadoSellsDetail()
        {
            //Escribimos los espacios para mostrar el articulo. En total tienen que ser 40 caracteres
            linea.AppendLine("CLIENTE                   |SUBT. |DTO. |TOTAL");
        }
        ...
        public void TextoExtremos(string textoIzquierdo, string textoDerecho)
        {
            ...
            int nroEspacios = maxCar - (textoIzq.Length + textoDer.Length)-5;
        ...
        public void AgregarTotales2(string texto, decimal total,int cutmax)
        {
            //Variables que usaremos
            string resumen, valor, textoCompleto, espacios = "";
            ...
            //Obtenemos el numero de espacios restantes para alinearlos a la derecha
            int nroEspacios = maxCar - (resumen.Length + valor.Length) - cutmax;
            //agregamos los espacios
            for (int i = 0; i < nroEspacios; i++)
            {
                espacios += "  ";
        ...
        public void AgregaArticulo(string articulo, double cant, decimal precio, decimal importe)
        {
            ...
            if (cant.ToString().Length <= 5 && precio.ToString().Length <= 7 && importe.ToString().Length <= 8)
            {
                ...
                else //Si no es mayor solo agregarlo, sin dar saltos de lineas
                {
                    ...
                    //Colocar la cantidad a la derecha.
                    nroEspacios = (9 - cant.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
        ...
        public void AgregaArticulo3(string articulo, decimal cant, decimal precio, decimal importe)
        {
            //Valida que cant precio e importe esten dentro del rango.
            if (cant.ToString().Length <= 5 && precio.ToString().Length <= 7 && importe.ToString().Length <= 8)
            {
        ...
        public void AgregaArticulo2(string articulo, double cant, decimal precio, decimal importe)
        {
            //Valida que cant precio e importe esten dentro del rango.
            if (cant.ToString().Length <= 5 && precio.ToString().Length <= 7 && importe.ToString().Length <= 8)
            {
                ...
                {
                    //Colocar la cantidad a la derecha.
                    nroEspacios = (13 - cant.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";//Generamos los espacios necesarios para alinear a la derecha
                    ...
                    //Colocar el precio a la derecha.
                    nroEspacios = (13 - precio.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";//Genera los espacios
                    ...
                    //Colocar el importe a la derecha.
                    nroEspacios = (14 - importe.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                ...
                else //Si no es mayor solo agregarlo, sin dar saltos de lineas
                {
                    ...
                    //Colocar la cantidad a la derecha.
                    nroEspacios = (13 - cant.ToString().Length);// +(20 - elemento.Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
