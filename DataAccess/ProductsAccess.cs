...
namespace DataAccess
{
    public class ProductsAccess : ConnectionMySQL
    {
        ...
        public DataTable ListProducts(string keyword)
        {
            ...
            using (var connection = GetConnection())
            {
                ...
                using (var command = new MySqlCommand())
                {
                    ...
                    command.CommandText = @"
                       ...
                       SELECT nombre as Nombre, preciov as PrecioVenta,codebar  FROM  products where family =@keyword order by nombre
                    ...
                    // MySqlDataReader reader = command.ExecuteReader();
                    Console.WriteLine("entre a verificar si hay filas en productos familias");
            ...
            using (var connection = GetConnection())
            {
                ...
                using (var command = new MySqlCommand())
                {
                    ...
                    command.CommandText = @"
                        ...
                        from sellsdetail inner join users on sellsdetail.user = users.id where 
                        sellsdetail.user = @user and cast(dt as date) = @date  order by sellsdetail.id desc
            ...
            using (var connection = GetConnection())
            {
                ...
                using (var command = new MySqlCommand())
                {
                    ...
                    command.CommandText = @"
                        ...
                        and cast(dt as date) = @date  order by id desc
                        ";
